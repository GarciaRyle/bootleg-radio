    ...
    <div id="sidebar">
        ...
        <div class="flex-wrap"> <br> <br>
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <input id="email" type="email" placeholder="Username" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?> signup " name="email" value="<?php echo e(old('email')); ?>" required autofocus style="background-color: #c2b396; border-radius: 10px; width: 180px; height: 40px; font-family: 'Lato', sans-serif; font-size: 14px; color:#a2321a;">
                ...
                <input id="password" type="password" placeholder="Password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?> signup" name="password" required style="background-color: #c2b396; border-radius: 10px; width: 180px; height: 40px; font-family: 'Lato', sans-serif; font-size: 14px; color:#a2321a; ">
