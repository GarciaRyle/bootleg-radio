...
<div class="row">
 <div class="col-md-12">
  ...
  <?php endif; ?>
  <div align="right">
   <a href="<?php echo e(url('bands/create')); ?>" class="btn btn-primary">Add</a>
   <br />
   <br />
  </div>
  <table class="table table-bordered table-striped">
   ...
   <?php $__currentLoopData = $bands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <tr>
    <td><?php echo e($row['bandName']); ?></td>
    <td><?php echo e($row['genre']); ?></td>
    <td><?php echo e($row['bandDescription']); ?></td>


    <td><a href="<?php echo e(action('BandRegController@edit', $row['id'])); ?>" class="btn btn-warning">Edit</a></td>
    <td>
     <form method="post" class="delete_form" action="<?php echo e(action('BandRegController@destroy', $row['id'])); ?>">
