...
#bandMembers
Route::get('/AddBandMember', 'bandMemController@showCreatePage')->name('AddBandMember');
Route:: post('/Member/store', 'bandMemController@store')->name('AddBandMemberstore');
Route:: get('/Member/show/{id}', 'bandMemController@show'); 
Route:: post('/Member/update/{id}', 'bandMemController@update'); 
Route:: get('/Member/delete', 'bandMemController@delete'); 
