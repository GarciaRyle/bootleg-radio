                            ...
                            <form method="post" action="{{action('BandRegController@store')}}" enctype="multipart/form-data">
                                ...
                                <center>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bandName" placeholder="Band Name" pattern="[a-zA-Z,0-9]{1,20}" class="form-control required" value="{{ old('bandName') }}" style="font-family: 'Lato', sans-serif;width: 300px; border-radius: 20px;" maxlength="50">
