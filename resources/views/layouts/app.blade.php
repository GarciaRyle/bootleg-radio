                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('/profile') }}" style="color: #b4a484; font-family: 'Lato', sans-serif; font-size: 16px;"><i class="fa fa-btn fa-user"></i>&nbsp;Profile</a></li>
                            <li><a href="{{ action('BandRegController@create') }}" style="color: #b4a484; font-family: 'Lato', sans-serif; font-size: 16px;"><i class="fas fa-plus-square"></i> &nbsp; Create Band</a></li>
                            <li><a href="{{ action('BandRegController@index') }}" style="color: #b4a484; font-family: 'Lato', sans-serif; font-size: 16px;"><i class="far fa-eye"></i> &nbsp; View Profile</a></li>


                            <li><a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" style="color: #b4a484; font-family: 'Lato', sans-serif; font-size: 16px;"><i class="fas fa-sign-out-alt"></i>
                                    &nbsp; {{ __('Logout') }}
                                </a></li>
