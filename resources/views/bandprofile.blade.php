    ...
    <div class="bandprofile">
        <div class="box1">
            <div>
                ...
                <span class="text2">&nbsp Band Name</span>
                <div class="text3">&nbsp Genre</div><br><br>
                <hr color: #c2b396>
                <div class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget tincidunt mauris, sit amet tristique orci. Vestibulum lacinia dui turpis, vitae finibus lorem vehicula vel. Ut a est sit amet mi consectetur venenatis</div> <br><br>

                <center><p style="color: #141311; font-size: 20px; font-family: 'Lato', sans-serif;"> BAND MEMBERS</p></center>
